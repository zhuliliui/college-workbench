...
const posPath = 'D:\\buddycode\\college-workbench\\replace_pos.json';

const content = fs.readFileSync(filePath, 'utf8');
const { firstIdIdx, endPos } = JSON.parse(fs.readFileSync(posPath, 'utf8'));
...
// 替换前20篇
const newContent = content.substring(0, firstIdIdx) + newArticles + content.substring(endPos);
