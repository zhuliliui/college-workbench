...
Pages.travel = function () {
  ...
  <div class="ops">
  <button class="btn btn-soft btn-icon" data-act="sch-edit" data-id="${x.id}"><img class="ic" src="assets/icons/hk-32.png" alt=""/></button>
  <button class="btn btn-soft btn-icon" data-act="sch-del" data-id="${x.id}"><img class="ic" src="assets/icons/hk-18.png" alt=""/></button>
  </div>
  </div>`).join('') + `</div>`
  : `<div class="empty"><img class="emoji" src="assets/icons/hk-35.png" alt=""/><div class="t">还没有行程安排</div><div class="s">添加每日路线、景点与时间段</div></div>`;
  ...
  <td><button class="btn btn-soft btn-icon" data-act="bud-edit" data-id="${b.id}"><img class="ic" src="assets/icons/hk-32.png" alt=""/></button>
  <button class="btn btn-soft btn-icon" data-act="bud-del" data-id="${b.id}"><img class="ic" src="assets/icons/hk-18.png" alt=""/></button></td>
  </tr>`;
  ...
  : `<div class="empty"><img class="emoji" src="assets/icons/hk-02.png" alt=""/><div class="t">还没有预算分项</div></div>`;

  // 物品
  const packHtml = t.checklist.length ? '<div class="list">' + t.checklist.map((x) => `
  <div class="item ${x.checked ? 'done' : ''}" data-id="${x.id}">
  <button class="check" data-act="pack-toggle" data-id="${x.id}">${x.checked ? '<img class="ic" src="assets/icons/hk-38.png" alt=""/>' : ''}</button>
  <div class="body"><div class="name">${UI.esc(x.name)}</div></div>
  <button class="btn btn-soft btn-icon" data-act="pack-del" data-id="${x.id}"><img class="ic" src="assets/icons/hk-18.png" alt=""/></button>
  </div>`).join('') + '</div>'
  : `<div class="empty"><img class="emoji" src="assets/icons/hk-04.png" alt=""/><div class="t">还没有物品清单</div></div>`;

  c.innerHTML = `
  <div class="card">
  <div class="card-head"><div class="title"><img class="ic" src="assets/icons/hk-35.png" alt=""/>行程时间表</div>
  ...
  <div class="card">
  <div class="card-head"><div class="title"><img class="ic" src="assets/icons/hk-02.png" alt=""/>旅行预算统计</div>
  ...
  <div class="card">
  <div class="card-head"><div class="title"><img class="ic" src="assets/icons/hk-04.png" alt=""/>物品核对清单</div>
  ...
  <div class="card">
  <div class="card-head"><div class="title"><img class="ic" src="assets/icons/hk-38.png" alt=""/>备忘笔记</div>
  ...
  if (act === 'pack-add') { UI.openModal({ title: '添加物品', icon: '<img class="ic" src="assets/icons/hk-04.png" alt=""/>', body: `<div class="field"><label>物品名称</label><input class="input" id="pk" placeholder="如：充电宝"/></div>`,
  ...
  UI.openModal({ title: x ? '编辑行程' : '添加行程', icon: '<img class="ic" src="assets/icons/hk-35.png" alt=""/>',
  body: `
  <div class="row">
  ...
  UI.openModal({ title: b ? '编辑预算分项' : '添加预算分项', icon: '<img class="ic" src="assets/icons/hk-02.png" alt=""/>',
  body: `
