...
Pages.study = function () {
  ...
  let listHtml;
  if (tasks.length === 0) {
  listHtml = `<div class="empty"><img class="emoji" src="assets/icons/hk-38.png" alt=""/>
  ...
  <div class="card">
  <div class="card-head">
  <div class="title"><img class="ic" src="assets/icons/hk-38.png" alt=""/>学习复习任务</div>
  <span class="sub">完成 1 项 +1 元存入奖励存钱罐（误触取消会扣回）</span>
  ...
  <div class="card">
  <div class="card-head">
  <div class="title"><img class="ic" src="assets/icons/hk-32.png" alt=""/>今日进度</div>
  <div class="spacer"></div>
  <button class="collapse-btn" title="折叠">▾</button>
  </div>
  <div class="card-body">
