...
Pages.review = function () {
  ...
  <div class="card">
  <div class="card-head"><div class="title"><img class="ic" src="assets/icons/hk-37.png" alt=""/>月度任务日历</div>
  <div class="spacer"></div><button class="collapse-btn" title="折叠">▾</button></div>
  <div class="card-body">
  ...
  <div class="check" style="background:${t.done ? 'var(--primary)' : '#fff'};border-color:var(--primary)">${t.done ? '<img class="ic" src="assets/icons/hk-38.png" alt=""/>' : ''}</div>
  ...
  : `<div class="empty"><img class="emoji" src="assets/icons/hk-38.png" alt=""/><div class="t">当天没有学习任务</div><div class="s">在「学习复习计划」中添加带日期的任务即可联动</div></div>`;
  UI.openModal({ title: dateStr + ' 学习任务', icon: '<img class="ic" src="assets/icons/hk-38.png" alt=""/>', body, dismissable: true });
  }
};
